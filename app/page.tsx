    ...
    return (
        <main className="bg-gray-100 h-screen flex items-center justify-center p-10 ">
            <div className="bg-white shadow-lg p-5 rounded-3xl w-full max-w-screen-sm flex flex-col gap-2">
                <input
                    className="w-full rounded-full h-12 py-3 bg-gray-200 pl-5 outline-none ring ring-transparent focus:ring-orange-500 focus:ring-ofsset-2 transition-shadow placeholder:drop-shadow"
                    type="text"
